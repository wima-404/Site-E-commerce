                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__language">
                                ...
                                <a href="index.php?lang=fr"><?php echo $lang['fran'];?></a>
                                <span class="arrow_carrot-down"></span>
                                <ul>
                                    <li><a href="index.php?lang=en"><?php echo $lang['ang'];?></a></li>
                                    <li><a href="index.php?lang=ar"><?php echo $lang['arb'];?></a></li>
                                </ul>
                            </div>
                ...
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            ...
                            <li><a href="#"><?php echo $lang['poissn'];?></a></li>
                            <li><a href="#"><?php echo $lang['pret'];?></a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-9">
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form class="mehdi" action="#">
                                ...
                                <button type="submit" class="site-btn"><?php echo $lang['rech'];?></button>
                            </form>
                        </div>
                    ...
                    <div class="hero__item set-bg" data-setbg="img/hero/banner2.jpeg">
                        <div class="hero__text">
                            ...
                            <h2><?php echo $lang['poisss'];?> <br />100% <?php echo $lang['ultra'];?></h2>

                            <p style="font-size: large; color: black;"><?php echo $lang['livex'];?> </p>

                            <a href="#" class="primary-btn"><?php echo $lang['dec'];?></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="categories__slider owl-carousel">
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/bar.jpg">
                            <h5><a href="#"><?php echo $lang['poissf'];?></a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
            ...
            <div class="row featured__filter">
                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#"><?php echo $lang['crev'];?></a></h6>
                            <h5>$30.00</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix vegetables fastfood">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#"><?php echo $lang['moule'];?></a></h6>
                            <h5>$30.00</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix vegetables fresh-meat">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#"><?php echo $lang['raie'];?></a></h6>
                            <h5>$30.00</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix fastfood oranges">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#"><?php echo $lang['sardin'];?></a></h6>
                            <h5>$30.00</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix fresh-meat vegetables">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#"><?php echo $lang['merlan'];?></a></h6>
                            <h5>$30.00</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fastfood">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#"><?php echo $lang['calamar'];?></a></h6>
                            <h5>$30.00</h5>
                        </div>
                    </div>
                </div>
